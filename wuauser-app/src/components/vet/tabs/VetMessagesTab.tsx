    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        <View style={styles.iconContainer}>
          <Ionicons name="chatbubbles" size={64} color={vetTheme.colors.primary} />
        </View>
        <Text style={styles.title}>Próximamente - Mensajes</Text>
        <Text style={styles.subtitle}>
          Aquí podrás ver y responder todos los mensajes de tus clientes
        </Text>
      </View>
    </SafeAreaView>
  );
